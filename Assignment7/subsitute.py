...
#A mjaority of this code was assisted by my collegue Kevin Clemmons. Few of the functions are of my desighn, however Kevin has assited my with a mjaority of code for some of the algorithims.
#The rest was aquired from the recommneded readings from the prompt.
...
# This code taken from page 25 in collective intelligence book
def get_user_match(name=None,gender=None,age=None,occupation=None):
	...
	# Creates a dictionary of users and the movies that they rated.
...
#This portion of the code was aquired form teh assistance of Kevin Clemmons 
		if args.name:
			name = args.name
